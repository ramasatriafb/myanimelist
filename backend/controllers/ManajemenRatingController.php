...
/**
 * ManageController implements the CRUD actions for MempunyaiRating model.
 */
class ManajemenRatingController extends Controller
{
    /**
     * @inheritdoc
     */
  public function behaviors()
    ...
    {
           $sql = "SELECT a.id 'id', anime_title,rating FROM mempunyairating a, anime b, user c where a.anime_id = b.anime_id and a.user_id = c.user_id order by id desc ";
